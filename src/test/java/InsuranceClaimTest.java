...
class InsuranceClaimTest {
    ...
    @Test
    @DisplayName("Constructor throws exception for null or empty claim ID")
    void testConstructorInvalidId() {
        assertThrows(IllegalArgumentException.class, () -> new InsuranceClaim(null, 1000));
        assertThrows(IllegalArgumentException.class, () -> new InsuranceClaim("", 1000));
    }
